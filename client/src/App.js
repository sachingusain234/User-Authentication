  ...
  if (loggedIn) {
    return (
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <p className="mt-4 text-center text-sm text-gray-500">You are logged in!</p>
      </div>
    );
  }
    ...
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <p className="mt-10 text-center text-sm text-gray-500">
          Not a member?{' '}
          <a href="/signUp.js" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">
            Sign up now
          </a>
        </p>
      </div>
